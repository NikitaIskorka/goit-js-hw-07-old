...
const doStuffOnClick = () => { console.log('hi') };


const decrement = ()=>{ valueRef.textContent > 0 ?valueRef.textContent= valueRef.textContent-1 :  0}
const increment = ()=>{valueRef.textContent = Number(valueRef.textContent)+1}
